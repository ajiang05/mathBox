...
which becomes explicit when the theory is embedded in a two-derivative, two-field \recordmath{O(1,1)}-symmetric perturbative field theory. 
\end{abstract}
...
\section{The \texorpdfstring{\recordmath{R_t}}{Rt}-homomorphism}\label{app:R_map}
